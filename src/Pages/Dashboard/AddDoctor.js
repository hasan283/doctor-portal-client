...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://dry-bastion-96276.herokuapp.com/services').then(res => res.json()));
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    // send to database 
                    fetch('https://dry-bastion-96276.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
